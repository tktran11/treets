...
# Cell
def convert_loggings(data_scource, target_text, identifier):
    """
    Description:\n
       This function convert all the loggings in the data_scource file into a list of individual items based on the target_text column. This function is based on a built-in vocabulary dictionary and an n-gram searcher.\n
