...
def breakfast_mean_with_error_bar(in_path, identifier, date_col, time_col, min_log_num=2, min_separation=4):
    """
    Description:\n
       This function takes the loggings in good logging days, calculates the means and standard deviations of breakfast time and represent with a scatter plot.\n
...
def dinner_mean_with_error_bar(in_path, identifier, date_col, time_col, min_log_num=2, min_separation=4):
    """
    Description:\n
       This function takes the loggings in good logging days, calculates the means and standard deviations of dinner time and represent with a scatter plot.\n
