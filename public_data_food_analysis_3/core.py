...
__all__ = ['universal_key', 'find_date', 'find_local_time', 'week_from_start', 'load_public_data',
           'filtering_usable_data', 'prepare_baseline_and_intervention_usable_data', 'get_adherent_column',
...
# Cell
def find_local_time(in_path, col, h=0):
    """
    Description:\n
